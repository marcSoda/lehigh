...
public class PacGUI extends JFrame {
   ...
   public PacGUI(PackageWorld world, boolean autorun) {
      ...
      // Set the color of the GUI components
      ...
      Color textBackground = new Color(80, 80, 80);
      Color textForeground = new Color(200, 200, 200);
      Color sliderBackground = new Color(60, 60, 60);
      Color sliderForeground = new Color(200, 200, 200);

      UIManager.put("Slider.background", sliderBackground);
      UIManager.put("Slider.foreground", sliderForeground);
      ...
      mapPanel.setPreferredSize(new Dimension(world.getWorldSize() * 30, world.getWorldSize() * 30));
      // reset = false;
